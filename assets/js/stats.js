const chartsConfig = [
  {
    id: "stats-0",
    type: "line",
    labels: Array.from({ length: 30 }, (_, i) => `3/${i}`),
    datasets: [{
      label: "Visits",
      borderColor: "rgba(174,155,255,0.67)",
      pointBackgroundColor: "#C0B2FC",
      pointBorderColor: "#AE9BFF",
      data: [120,140,160,180,200,220,210,230,250,270,260,280,300,320,310,330,350,370,360,380,400,420,410,430,450,470,460,480,500,520],
      pointRadius: 4,
      borderWidth: 1,
      fill: false
    }],
  ...
  },
  {
    ...
    title: "Sales pro Wochentag"
  },
  {
    id: "stats-2",
    type: "line",
    labels: Array.from({ length: 20 }, (_, i) => `4/${i}`),
    datasets: [
  ...
  },
  {
    ...
    title: "Umsatz pro Quartal",
    stacked: true
  },
  {
    id: "stats-4",
    type: "line",
    labels: Array.from({ length: 15 }, (_, i) => `5/${i}`),
    datasets: [{
      label: "Active Users",
      borderColor: "#a78bfa",
...
chartsConfig.forEach(cfg => {
  ...
  new Chart(ctx, {
    ...
    options: {
      ...
      scales: {
        x: {
          ticks: { color: "#444363", font: { size: 12 } },
